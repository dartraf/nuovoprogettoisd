...
Begin VB.Form frmPaziente 
   ...
   Begin TabDlg.SSTab tabScheda 
      ...
      Tab(0).Control(39)=   "Label1(51)"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "oData(2)"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "oData(1)"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "oData(0)"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "chkEsenteReddito"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "txtNome"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "txtCognome"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "txtCitta"
      ...
      Begin VB.CommandButton cmdEliminaAccompagnatore 
         ...
         Style           =   1  'Graphical
         TabIndex        =   125
         ToolTipText     =   "Elimina l' accompagnatore"
         Top             =   7290
         Width           =   375
      End
...
Private Sub txtAltezza_GotFocus()
    txtAltezza.BackColor = colArancione
End Sub

Private Sub txtAltezza_KeyPress(KeyAscii As Integer)
...
Private Sub txtAltezza_LostFocus()
    txtAltezza.BackColor = vbWhite
End Sub
