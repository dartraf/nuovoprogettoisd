...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("corpo").Controls
            ...
            .Item("txtGiornoGen").DataField = "GIORNO_GEN"
            .Item("txtGiornoFeb").DataField = "GIORNO_FEB"
            .Item("txtGiornoMar").DataField = "GIORNO_MAR"
            .Item("txtGiornoApr").DataField = "GIORNO_APR"
            .Item("txtGiornoMag").DataField = "GIORNO_MAG"
            .Item("txtGiornoGiu").DataField = "GIORNO_GIU"
            .Item("txtGiornoLug").DataField = "GIORNO_LUG"
            .Item("txtGiornoAgo").DataField = "GIORNO_AGO"
            .Item("txtGiornoSet").DataField = "GIORNO_SET"
            .Item("txtGiornoOtt").DataField = "GIORNO_OTT"
