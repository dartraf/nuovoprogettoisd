...
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptCartellaClinica_1 
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Luogo di nascita"
      EndProperty
      ItemType1       =   3
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
      ...
      BeginProperty Item14 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Documento di riconoscimento"
      EndProperty
      ItemType15      =   4
      ...
      BeginProperty Item16 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Medico curante"
      EndProperty
      ItemType17      =   4
      BeginProperty Item17 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         Name            =   "TxtMedicoCuranteCognome"
         Object.Left            =   1815
         Object.Top             =   8164
         Object.Width           =   2730
         Object.Height          =   345
      ...
      BeginProperty Item19 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Recapito medico curante"
      EndProperty
      ItemType20      =   4
      BeginProperty Item20 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         Name            =   "TxtNumeroMedico"
         Object.Left            =   2721
         Object.Top             =   8957
         Object.Width           =   2041
         Object.Height          =   284
      ...
      BeginProperty Item41 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Codice di esenzione"
      EndProperty
      ItemType42      =   4
   ...
   EndProperty
End
Attribute VB_Name = "rptCartellaClinica_1"
...
Dim WithEvents sdfGruppoSanguigno  As StdDataFormat
Attribute sdfGruppoSanguigno.VB_VarHelpID = -1
Dim WithEvents sdfRh  As StdDataFormat
Attribute sdfRh.VB_VarHelpID = -1
Dim WithEvents sdfTipo  As StdDataFormat
Attribute sdfTipo.VB_VarHelpID = -1
Dim WithEvents sdfStato  As StdDataFormat
Attribute sdfStato.VB_VarHelpID = -1
...
Private Sub DataReport_Initialize()
    Set sdfGruppoSanguigno = New StdDataFormat
    Set sdfRh = New StdDataFormat
    Set sdfTipo = New StdDataFormat
    Set sdfStato = New StdDataFormat
    ...
    With Me
        ...
        With .Sections("corpo").Controls
            .Item("TxtProvenienza").DataField = "CITTA_NASCITA"
            .Item("txtCitta").DataField = "CITTA_RESIDENZA"
            ...
            .Item("TxtNumeroCarta").DataField = "CODICE_DOCUMENTO"
            .Item("TxtMedicoCuranteCognome").DataField = "COGNOME_MEDICO"
            .Item("TxtMedicoCuranteNome").DataField = "NOME_MEDICO"
            .Item("TxtNumeroMedico").DataField = "TELEFONO_MEDICO"
            .Item("TxtAsl").DataField = "ASL"
            .Item("txtGruppoSanguigno").DataField = "GRUPPO_SANGUIGNO"
            .Item("txtRh").DataField = "RH"
            .Item("txtEsenzione").DataField = "ESENZIONE"
            ...
            Set .Item("txtRh").DataFormat = sdfRh
            Set .Item("txtStato").DataFormat = sdfStato
        End With
...
Private Sub sdfStato_Format(ByVal DataValue As StdFormat.StdDataValue)
    DataValue = Choose(DataValue + 1, "In dialisi", "Deceduto", "Trasferito", "Trapiantato", "Ospite")
End Sub

Private Sub sdfGruppoSanguigno_Format(ByVal DataValue As StdFormat.StdDataValue)
    If DataValue <> -1 Then
        DataValue = Choose(DataValue + 1, "A", "B", "AB", "0")
    Else
        DataValue = ""
    End If
End Sub

Private Sub sdfRh_Format(ByVal DataValue As StdFormat.StdDataValue)
    If DataValue <> -1 Then
        DataValue = Choose(DataValue + 1, "Positivo", "Negativo", "")
    Else
        DataValue = ""
    End If
End Sub
...
Private Sub sdfTipo_Format(ByVal DataValue As StdFormat.StdDataValue)
    If DataValue = -1 Then
        DataValue = ""
    Else
        DataValue = Choose(DataValue + 1, "C.I.", "PTT", "PSP")
    End If
End Sub
