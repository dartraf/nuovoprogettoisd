VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptCartellaClinica_2 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Anamnesi Patologica"
   ClientHeight    =   9036
   ClientLeft      =   48
   ClientTop       =   312
   ClientWidth     =   10344
   ...
   EndProperty
End
Attribute VB_Name = "rptCartellaClinica_2"
...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("livello1").Controls
            .Item("txtNomeAnamnesi").DataField = "NOME_ANAMNESI"
        End With
        
        With .Sections("corpo").Controls
            .Item("txtTesto").DataField = "TESTO"
            .Item("txtTesto").DataMember = "RES1"
        End With
