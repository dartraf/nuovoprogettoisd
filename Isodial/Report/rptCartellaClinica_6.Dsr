VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptCartellaClinica_6 
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Esami di laboratorio"
      EndProperty
      ItemType2       =   3
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item16 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Ultimo aggiornamento del dr./dr.ssa:"
      EndProperty
      ItemType17      =   4
   ...
   EndProperty
   SectionCode7    =   7
   BeginProperty Section7 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      _Version        =   393216
      Name            =   "Pie"
      Object.Height          =   913
      NumControls     =   4
   ...
   EndProperty
   SectionCode8    =   8
   BeginProperty Section8 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      _Version        =   393216
      Name            =   "Section5"
      NumControls     =   0
   EndProperty
End
Attribute VB_Name = "rptCartellaClinica_6"
...
Dim WithEvents sdfAnno  As StdDataFormat
Attribute sdfAnno.VB_VarHelpID = -1
...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        End With
        With .Sections("level1").Controls
            .Item("txtAnno").DataField = "ANNO"
            Set .Item("txtAnno").DataFormat = sdfAnno
        End With
        With .Sections("level2").Controls
            .Item("txtGruppo").DataMember = "RES1"
            .Item("txtGruppo").DataField = "NOME_GRUPPO"
            For i = 1 To 12
                .Item("txtData" & i).DataMember = "RES1"
                .Item("txtData" & i).DataField = "DATA" & i
                .Item("txtUtente" & i).DataMember = "RES1"
                .Item("txtUtente" & i).DataField = "UTENTE" & i
            Next i
        End With
        With .Sections("corpo").Controls
            .Item("txtEsame").DataMember = "RES2"
            .Item("txtLegenda").DataMember = "RES2"
            .Item("txtUnita").DataMember = "RES2"
            .Item("txtMinMax").DataMember = "RES2"
            .Item("txtEsame").DataField = "NOME_ESAME"
            .Item("txtLegenda").DataField = "LEGENDA"
            .Item("txtUnita").DataField = "UNITA"
            .Item("txtMinMax").DataField = "V_MINMAX"
            For i = 1 To 12
                .Item("txtValore" & i).DataMember = "RES2"
                .Item("txtValore" & i).DataField = "VALORE" & i
            Next i
        End With
...
Private Sub sdfAnno_Format(ByVal DataValue As StdFormat.StdDataValue)
    DataValue = Right(DataValue, 4)
End Sub
