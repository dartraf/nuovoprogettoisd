VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptCartellaClinica_7 
   ...
   EndProperty
End
Attribute VB_Name = "rptCartellaClinica_7"
...
Dim WithEvents sdfSomministrazione  As StdDataFormat
Attribute sdfSomministrazione.VB_VarHelpID = -1
...
Private Sub DataReport_Initialize()
    Set sdfSomministrazione = New StdDataFormat
    ...
    With Me
        ...
        With .Sections("livel1").Controls
            ...
            .Item("txtIntestazioneSospesa").DataField = "INTESTAZIONE_SOSPESA"
        End With
        With .Sections("corpo").Controls
            ...
            .Item("txtDataSospesa").DataField = "DATA_SOSPESA"
            .Item("txtDataSospesa").DataMember = "Res1"
            
            .Item("txtData1").DataField = "DATA_1"
            .Item("txtData1").DataMember = "Res1"
            
            .Item("txtData2").DataField = "DATA_2"
            .Item("txtData2").DataMember = "Res1"
            
            .Item("txtData3").DataField = "DATA_3"
            .Item("txtData3").DataMember = "Res1"
...
Private Sub sdfSomministrazione_Format(ByVal DataValue As StdFormat.StdDataValue)
    If DataValue = 0 Then
        DataValue = ""
    ElseIf DataValue = 1 Then
        DataValue = "Intradialitica"
    ElseIf DataValue = 2 Then
        DataValue = "Postdialitica"
    End If
End Sub
