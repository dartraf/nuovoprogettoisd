VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptConsumiPrevisioni 
   ...
   EndProperty
End
Attribute VB_Name = "rptConsumiPrevisioni"
...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("corpo").Controls
            ...
            .Item("txtNomeConsumi").DataField = "NOME_CONSUMI"
            .Item("txtGiornoGen").DataField = "CONSUMI_GEN"
            .Item("txtGiornoFeb").DataField = "CONSUMI_FEB"
            .Item("txtGiornoMar").DataField = "CONSUMI_MAR"
            .Item("txtGiornoApr").DataField = "CONSUMI_APR"
            .Item("txtGiornoMag").DataField = "CONSUMI_MAG"
            .Item("txtGiornoGiu").DataField = "CONSUMI_GIU"
            .Item("txtGiornoLug").DataField = "CONSUMI_LUG"
            .Item("txtGiornoAgo").DataField = "CONSUMI_AGO"
            .Item("txtGiornoSet").DataField = "CONSUMI_SET"
            .Item("txtGiornoOtt").DataField = "CONSUMI_OTT"
            .Item("txtGiornoNov").DataField = "CONSUMI_NOV"
            .Item("txtGiornoDic").DataField = "CONSUMI_DIC"
            .Item("txtTotaleConsumi").DataField = "TOTALE_CONSUMI"
