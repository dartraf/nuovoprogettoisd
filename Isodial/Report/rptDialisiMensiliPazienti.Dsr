   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "RIEPILOGO DIALISI MENSILI"
         Alignment       =   2
      EndProperty
      ItemType1       =   3
...
Private Sub DataReport_Initialize()
    With Me
        ...
        With .Sections("corpo").Controls
            ...
            .Item("txtDialisiGen").DataField = "DIALISI_GEN"
            .Item("txtDialisiFeb").DataField = "DIALISI_FEB"
            .Item("txtDialisiMar").DataField = "DIALISI_MAR"
            .Item("txtDialisiApr").DataField = "DIALISI_APR"
            .Item("txtDialisiMag").DataField = "DIALISI_MAG"
            .Item("txtDialisiGiu").DataField = "DIALISI_GIU"
            .Item("txtDialisiLug").DataField = "DIALISI_LUG"
            .Item("txtDialisiAgo").DataField = "DIALISI_AGO"
            .Item("txtDialisiSet").DataField = "DIALISI_SET"
            .Item("txtDialisiOtt").DataField = "DIALISI_OTT"
            .Item("txtDialisiNov").DataField = "DIALISI_NOV"
            .Item("txtDialisiDic").DataField = "DIALISI_DIC"
            .Item("txtTotale").DataField = "TOTALE"
