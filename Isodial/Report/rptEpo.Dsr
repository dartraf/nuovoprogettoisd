VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptEpo 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Stampa Dose Eritropoietina per Paziente"
   ClientHeight    =   8535
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   13170
...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("corpo").Controls
            ...
            For i = 1 To 12
                .Item("txtMese" & i).DataField = "MESE" & i
            Next i
