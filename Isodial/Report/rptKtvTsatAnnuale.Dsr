...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("corpo").Controls
            ...
            .Item("txtMese1").DataField = "MESE1"
            .Item("txtMese2").DataField = "MESE2"
            .Item("txtMese3").DataField = "MESE3"
            .Item("txtMese4").DataField = "MESE4"
            .Item("txtMese5").DataField = "MESE5"
            .Item("txtMese6").DataField = "MESE6"
            .Item("txtMese7").DataField = "MESE7"
            .Item("txtMese8").DataField = "MESE8"
            .Item("txtMese9").DataField = "MESE9"
            .Item("txtMese10").DataField = "MESE10"
