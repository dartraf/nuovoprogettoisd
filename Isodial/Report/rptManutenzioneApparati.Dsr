VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptManutenzioneApparati 
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item29 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Tipo Manutenzione"
      EndProperty
      ItemType30      =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptManutenzioneApparati"
...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("corpo").Controls
           .Item("txtTipoManutenzione").DataField = "TIPO_MANUTENZIONE"
           .Item("txtDataScadenzaManutenzione").DataField = "DATA_SCADENZA_MANUTENZIONE"
           .Item("txtDataRichiestaManutenzione").DataField = "DATA_RICHIESTA_MANUTENZIONE"
           .Item("txtDataeffettivaManutenzione").DataField = "DATA_EFFETTIVA_MANUTENZIONE"
           .Item("txtDescrizioneManutenzione").DataField = "DESCRIZIONE_MANUTENZIONE"
           .Item("txtNumeroDocumento").DataField = "NUMERO_DOCUMENTO"
           .Item("txtDettagliIntervento").DataField = "DETTAGLI_INTERVENTO"
        End With
    End With
