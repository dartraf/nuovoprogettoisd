...
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptModuloBartoli 
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Scheda dialitica settimanale"
         CanGrow         =   -1  'True
         Alignment       =   2
      EndProperty
      ItemType4       =   3
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Ultimi Esami di Laboratorio:"
      EndProperty
      ItemType3       =   4
      ...
      BeginProperty Item6 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "TERAPIA IN DIALISI"
         Alignment       =   2
      EndProperty
      ItemType7       =   5
      ...
      BeginProperty Item21 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         Name            =   "txtPesoDialiticoPrecedente"
         Object.Left            =   4250
         Object.Top             =   805
         Object.Width           =   510
         Object.Height          =   285
      ...
      BeginProperty Item24 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "P.A. Prec. (max/min)"
      EndProperty
      ItemType25      =   4
      BeginProperty Item25 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         Name            =   "txtFrequenzaPrecedente"
         Object.Left            =   9354
         Object.Top             =   805
         Object.Width           =   510
         Object.Height          =   285
   ...
   EndProperty
End
Attribute VB_Name = "rptModuloBartoli"
    ...
    With Me
       ...
       End With
        ...
        With .Sections("corpo").Controls
            ...
            .Item("txtEDTA").DataField = "EDTA"
            .Item("txtTempoDialisi").DataField = "DURATA_SEDUTA"
            
            .Item("txtPesoSecco").DataField = "PESO_SECCO"
            .Item("txtPesoDialiticoPrecedente").DataField = "PESO_DIALITICO_PRECEDENTE"
            .Item("txtPAPrecedente").DataField = "PRESSIONE_PRECEDENTE"
            .Item("txtFrequenzaPrecedente").DataField = "FREQUENZA_PRECEDENTE"
            ...
            .Item("txtFiltroSeduta3").DataField = "FILTRO_SEDUTA"
            .Item("txtFiltroSeduta4").DataField = "FILTRO_SEDUTA"
            
            
                                        ' 2ª PAGINA
                                        
            .Item("txtCognomeSecondo").DataField = "COGNOME"
            .Item("txtNomeSecondo").DataField = "NOME"
            .Item("txtAnniSecondo").DataField = "ANNI"
            .Item("txtCodiceIDSecondo").DataField = "CODICE_PAZIENTE"
                                        
            .Item("txtEmogruppoSecondo").DataField = "EMOGRUPPO"
            .Item("txtAccessoVascolareSecondo").DataField = "ACCESSO_VASCOLARE"
            .Item("txtEDTASecondo").DataField = "EDTA"
            .Item("txtTempoDialisiSecondo").DataField = "DURATA_SEDUTA"
                       
            .Item("txtEsame1").DataField = "ESAME1"
            .Item("txtEsame2").DataField = "ESAME2"
            .Item("txtEsame3").DataField = "ESAME3"
            .Item("txtEsame4").DataField = "ESAME4"
            .Item("txtEsame5").DataField = "ESAME5"
            .Item("txtEsame6").DataField = "ESAME6"
            .Item("txtEsame7").DataField = "ESAME7"
            .Item("txtEsame8").DataField = "ESAME8"
            .Item("txtEsame9").DataField = "ESAME9"
            .Item("txtEsame10").DataField = "ESAME10"
            .Item("txtEsame11").DataField = "ESAME11"
            .Item("txtEsame12").DataField = "ESAME12"
            .Item("txtEsame13").DataField = "ESAME13"
            .Item("txtEsame14").DataField = "ESAME14"
            .Item("txtEsame15").DataField = "ESAME15"
            .Item("txtEsame16").DataField = "ESAME16"
            
            
            '                       TERAPIA IN DIALISI
            
            .Item("txtFarmacoDialisi").DataField = "FARMACO_DIALISI"
            .Item("txtPosologiaDialisi").DataField = "POSOLOGIA_DIALISI"
            .Item("txtNoteDialisi").DataField = "NOTE_DIALISI"
            .Item("txtGiorniDialisi").DataField = "GIORNI_DIALISI"
            
            '                       TERAPIA DOMICILIARE
            
            .Item("txtFarmacoDomiciliare").DataField = "FARMACO_DOMICILIARE"
            .Item("txtPosologiaDomiciliare").DataField = "POSOLOGIA_DOMICILIARE"
            .Item("txtNoteDomiciliare").DataField = "NOTE_DOMICILIARE"
            .Item("txtGiorniDomiciliari").DataField = "GIORNI_DOMICILIARE"
