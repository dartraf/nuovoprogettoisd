VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptRichiestaIntervento 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Richiesta Intervento"
   ClientHeight    =   8676
   ClientLeft      =   48
   ClientTop       =   312
   ClientWidth     =   10908
   ...
   EndProperty
End
Attribute VB_Name = "rptRichiestaIntervento"
...
Private Sub DataReport_Initialize()
    With Me
        ...
        With .Sections("corpo").Controls
            .Item("txtTipologia").DataField = "TIPOLOGIA"
            .Item("txtModello").DataField = "MODELLO"
            .Item("txtMatricola").DataField = "MATRICOLA"
            .Item("txtMotivazioneRichiesta").DataField = "MOTIVAZIONE_RICHIESTA"
        End With
