VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptRiepilogoImpegnative 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Riepilogo Impegnative"
   ClientHeight    =   8868
   ClientLeft      =   48
   ClientTop       =   312
   ClientWidth     =   15264
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item17 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Data Inizio Prest."
         Alignment       =   2
      EndProperty
      ItemType18      =   3
      ...
      BeginProperty Item23 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Riepilogo impegnative del mese di:"
         Alignment       =   2
      EndProperty
      ItemType24      =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptRiepilogoImpegnative"
...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("corpo").Controls
            ...
            .Item("txtCSB").DataField = "PROGRESSIVO_RICETTA"
            .Item("txtDistretto").DataField = "NOME_DISTRETTO"
            .Item("txtNome").DataField = "NOME"
            .Item("txtCognome").DataField = "COGNOME"
            .Item("txtNumeroMazzetta").DataField = "MAZZETTA"
            .Item("txtNumeroPrestazione").DataField = "NUMERO_PRESTAZIONI"
            .Item("txtNumeroRicetta").DataField = "NUMERO_RICETTA"
            .Item("txtPrezzo").DataField = "TOTALE_LORDO"
