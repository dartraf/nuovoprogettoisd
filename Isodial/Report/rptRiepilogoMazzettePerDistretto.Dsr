VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptRiepilogoMazzettePerDistretto 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Riepilogo mazzette per distretto"
   ClientHeight    =   8670
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   10590
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Riepilogo Totale Mazzette per Distretti del mese di:"
      EndProperty
      ItemType4       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptRiepilogoMazzettePerDistretto"
 ...
 Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("corpo").Controls
            .Item("txtMazzetta").DataField = "MAZZETTE"
            .Item("txtNumeroImpegnative").DataField = "RICETTE"
            .Item("txtNumeroPrestazioni").DataField = "QUANTITA"
