...
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptRiepilogoMazzettaSingola 
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "N° prog. Mazzetta"
         Alignment       =   2
      EndProperty
      ItemType1       =   3
      ...
      BeginProperty Item9 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Numero Impegnative"
         Alignment       =   2
      EndProperty
      ItemType10      =   3
      BeginProperty Item10 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Numero Prestazioni"
         Alignment       =   2
      EndProperty
      ItemType11      =   3
      ...
      BeginProperty Item16 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Riepilogo Mazzetta N°"
         Alignment       =   2
      EndProperty
      ItemType17      =   4
      BeginProperty Item17 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         Name            =   "txtNumeroMazzetta"
         Object.Left            =   4649
         Object.Top             =   78
         Object.Width           =   510
         Object.Height          =   375
   ...
   EndProperty
End
Attribute VB_Name = "rptRiepilogoMazzettaSingola"
...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("livello1").Controls
            .Item("txtNumeroMazzetta").DataField = "NUMEROMAZZETTA1"
            .Item("txtNomeAsl").DataField = "NOME_ASL"
            .Item("txtNomeDistretto").DataField = "NOME_DISTRETTO"
            .Item("txtTotalePrestazioni").DataField = "PRESTAZIONI"
            .Item("txtTotaleImpegnative").DataField = "RICETTE"
            
            Set .Item("txtNumeroMazzetta").DataFormat = sdfZero
        End With
        
        With .Sections("corpo").Controls
                .Item("txtDistretto").DataMember = "RES1"
                .Item("txtDistretto").DataField = "NOME_DISTRETTO"
                .Item("txtAsl").DataMember = "RES1"
                .Item("txtAsl").DataField = "NOME_ASL"
                .Item("txtMazzetta2").DataMember = "RES1"
                .Item("txtMazzetta2").DataField = "NUMEROMAZZETTA2"
                .Item("txtNumeroProgressivo").DataMember = "RES1"
                .Item("txtNumeroProgressivo").DataField = "PROGRESSIVO_RICETTA"
                .Item("txtNumeroRicetta").DataMember = "RES1"
                .Item("txtNumeroRicetta").DataField = "NUMERO_RICETTA"
                .Item("txtNumeroPrestazioni").DataMember = "RES1"
                .Item("txtNumeroPrestazioni").DataField = "PRESTAZIONI"
                .Item("txtCognome").DataMember = "RES1"
                .Item("txtCognome").DataField = "COGNOME"
                .Item("txtNome").DataMember = "RES1"
...
Private Sub sdfZero_Format(ByVal DataValue As StdFormat.StdDataValue)
    'Me.Sections("intestazione").Controls.Item("TextBox1").Caption = DataValue
End Sub
