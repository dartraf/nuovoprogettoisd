VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptRiepilogoPerTotaliPerAsl 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Fattura per totali per Asl"
   ClientHeight    =   7650
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   11595
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Riepilogo totale per asl del mese di:"
         Alignment       =   2
      EndProperty
      ItemType2       =   7
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item5 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Num. prestazioni:"
      EndProperty
      ItemType6       =   4
   ...
   EndProperty
End
Attribute VB_Name = "rptRiepilogoPerTotaliPerAsl"
...
Private Sub DataReport_Initialize()
    ...
    With Me
        ...
        With .Sections("corpo").Controls
            .Item("txtAsl").DataField = "NOME"
            .Item("txtImportoLordo").DataField = "TOTALE_LORDO"
            .Item("txtImportoNetto").DataField = "TOTALE_NETTO"
            .Item("txtNumMazzette").DataField = "MAZZETTE"
            .Item("txtNumRicette").DataField = "RICETTE"
            .Item("txtNumPrestazioni").DataField = "PRESTAZIONI"
            .Item("txtImportoTicket").DataField = "TOTALE_TICKET"
