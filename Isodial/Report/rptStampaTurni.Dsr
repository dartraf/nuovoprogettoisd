VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptStampaTurni 
   ...
   EndProperty
End
Attribute VB_Name = "rptStampaTurni"
...
Set sdfTipo = New StdDataFormat
    ...
    With Me
        ...
        With .Sections("corpo").Controls
           ...
           .Item("txtGGIni1").DataField = "GGINI1"
           .Item("txtGGIni2").DataField = "GGINI2"
           .Item("txtGGIni3").DataField = "GGINI3"
           .Item("txtGGFin1").DataField = "GGFIN1"
           .Item("txtGGFin2").DataField = "GGFIN2"
           .Item("txtGGFin3").DataField = "GGFIN3"
           .Item("txtPostazione").DataField = "POSTAZIONE"
           .Item("txtNRene").DataField = "NUMERO_APPARATO"
