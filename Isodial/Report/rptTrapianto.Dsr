VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptTrapianto 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Pazienti candidati al trapianto"
   ClientHeight    =   9420
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   10515
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "PAZIENTI CANDIDATI AI TRAPIANTI"
         Alignment       =   2
      EndProperty
      ItemType3       =   3
      ...
      BeginProperty Item7 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Centro trapianti"
      EndProperty
      ItemType8       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptTrapianto"
    ...
    With Me
        ...
        With .Sections("intestazione").Controls
            ...
            If structIntestazione.sLogoISO Then
                If Dir(structApri.pathExe & "\logo.jpg", vbArchive) <> "" Then
                    Set .Item("imgLogoIso").Picture = LoadPicture(structApri.pathExe & "\logo.jpg")
                End If
            End If
            If structIntestazione.sLogoQualita Then
                If Dir(structApri.pathExe & "\logoQualita.jpg", vbArchive) <> "" Then
                    Set .Item("imgLogoQualita").Picture = LoadPicture(structApri.pathExe & "\logoQualita.jpg")
                End If
            End If
        End With
        ...
        With .Sections("corpo").Controls
            ...
            .Item("txtCentroTrapianti").DataField = "CENTRO_TRAPIANTI"
